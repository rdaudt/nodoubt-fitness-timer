...
| 01-01-02 | 01 | 1 | TMPL-01, SETG-02 | playwright | `npm run test:phase1 -- guest-home signed-in-home` | ❌ W0 | ⬜ pending |
...
| Bottom navigation appears on home/settings shell and is absent from the full-screen run route shell | LIBR-07, LIBR-08 | Visual shell behavior is easiest to validate in-browser before the run engine exists | Open guest and signed-in shell pages plus the run-route placeholder, confirm nav visibility matches the phase contract |
